...
SECRET_KEY = 'django-insecure-3a-xe@)_wgd)60o5iw2lc&h3sm%92)y!_z5$8h@5hhnz2%$+s3'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3', # المسار الآن صحيح بالنسبة لـ advanced_features_and_security
    }
}
